const links = {
  ...
  Services: ["Web Development", "Mobile Apps", "UI/UX Design", "Cloud & SaaS"],
          ...
          {Object.entries(links).map(([heading, items]) => (
            <div key={heading}>
              ...
              <ul style={{ listStyle: "none", padding: 0, margin: 0, display: "flex", flexDirection: "column", gap: "10px" }}>
                {items.map((item) => (
                  <li key={item}>
                    <a href="#" style={{ color: "rgba(255,255,255,0.45)", fontSize: "13px", textDecoration: "none", lineHeight: 1.5 }}>
                      {item}
                    </a>
                  </li>
                ))}
        ...
        <div style={{
          ...
          <div style={{ display: "flex", gap: "20px", flexWrap: "wrap" }}>
            {["Privacy Policy", "Terms of Service", "Cookie Policy"].map((t) => (
              <a key={t} href="#" style={{ color: "rgba(255,255,255,0.35)", fontSize: "12px", textDecoration: "none" }}>{t}</a>
            ))}
          </div>
        </div>
      </div>
